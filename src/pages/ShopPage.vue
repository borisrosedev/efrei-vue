<template>
  <main class="shop-page">
    <div aria-label="conteneur du titre de la page Shop" class="shop-page__title-container">
      <TitleComponent
      :h-type="'h1'"
      text-content="Shop"
      />
...
onMounted(async() => {
    console.log('Shop has mounted');
    console.log(products.value);
    getProducts();
    setNewMessage({ title: 'Shop Page', type: 'positive', content: 'N\'hésitez pas à remplir votre panier'})
    timer = setTimeout(() => {
        setContent('');
    }, 3000)
